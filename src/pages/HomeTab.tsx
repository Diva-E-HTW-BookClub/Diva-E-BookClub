            ...
            <IonContent fullscreen>
                ...
                {isNewUser &&
                    <>
                        <IonItem lines="none">
                            <IonLabel>
                                There are no upcoming discussions.<br/>
                                Join a Club or create your own!
                            </IonLabel>
                        </IonItem>
                        <IonItem lines="none">
                            <IonButton size="default" routerLink="/clubs">Start Now</IonButton>
                        </IonItem>
                    </>}
                {!isNewUser &&
                    <>
                        <ClubCard name={"Diva-E's BookClub"} member={3} date={"20.10.2022"} time={"13:00 - 14:00"}
